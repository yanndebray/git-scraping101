...
# Weather\-git\-scraping [![Open in MATLAB Online](https://www.mathworks.com/images/responsive/global/open-in-matlab-online.svg)](https://matlab.mathworks.com/open/github/v1?repo=yanndebray/git-scraping101&file=weatherscraper.mlx)
...
## Table of Contents
&emsp;&emsp;[Initialize](#initialize)
 
&emsp;&emsp;[Iterate](#iterate)
 
&emsp;&emsp;[Automate](#automate)
    ...
    steps:
      ...
      - name: Commit and push if it changed
        run: |
          ...
          git add -A
          timestamp= $(date -u)          git commit -m "Latest data: $ {timestamp}" || exit 0
            git push
env:
